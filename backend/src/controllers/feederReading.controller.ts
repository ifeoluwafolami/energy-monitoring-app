...
export const createFeederReading = async (req: Request, res: Response): Promise<void> => {
    try {
...
export const updateFeederReading = async (req: Request, res: Response): Promise<void> => {
    try {
        const { id } = req.params;
...
export const submitTodayReadings = async (req: Request, res: Response) => {
  try {
